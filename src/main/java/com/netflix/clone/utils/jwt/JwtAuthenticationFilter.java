package com.netflix.clone.utils.jwt;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void processAuthentication(@NonNull HttpServletRequest request, String jwt, String username) {
    ...
    private void setAuthenticationInContext(@NonNull HttpServletRequest request, UserDetails userDetails) {
